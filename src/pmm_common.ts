    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* pmm_common.U256 chain_id */ 1:
          message.chainId = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.chainId
...
class TransactionMetadata$Type extends MessageType<TransactionMetadata> {
  constructor() {
    super("pmm_common.TransactionMetadata", [
      ...
      {
        no: 6,
        name: "tracked_by_reader_timestamp",
        kind: "scalar",
        T: 4 /*ScalarType.UINT64*/,
        L: 0 /*LongType.BIGINT*/,
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.Address initiator */ 7:
          message.initiator = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.initiator
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.Address token_address */ 2:
          message.tokenAddress = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* pmm_common.U256 amount */ 3:
          message.amount = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.amount
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* pmm_common.U256 execution_fee */ 1:
          message.executionFee = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* pmm_common.Address fallback_address_dst */ 2:
          message.fallbackAddressDst = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.fallbackAddressDst
          );
          break;
        case /* pmm_common.U256 hash_of_external_call */ 3:
          message.hashOfExternalCall = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.hashOfExternalCall
          );
          break;
...
class Order$Type extends MessageType<Order> {
  constructor() {
    super("pmm_common.Order", [
      ...
      { no: 5, name: "receiver_dst", kind: "message", T: () => Address },
      {
        ...
        name: "external_call",
        kind: "message",
        T: () => ExternalCallParams,
      },
      {
        no: 7,
        name: "give_patch_authority_src",
        kind: "message",
        T: () => Address,
      },
      {
        no: 8,
        name: "order_authority_address_dst",
        kind: "message",
        T: () => Address,
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.Offer give */ 2:
          message.give = Offer.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.give
        ...
        case /* pmm_common.Offer take */ 3:
          message.take = Offer.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.take
        ...
        case /* pmm_common.Address maker_src */ 4:
          message.makerSrc = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.makerSrc
        ...
        case /* pmm_common.Address receiver_dst */ 5:
          message.receiverDst = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.receiverDst
        ...
        case /* pmm_common.ExternalCallParams external_call */ 6:
          message.externalCall = ExternalCallParams.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* pmm_common.Address allowed_taker_dst */ 9:
          message.allowedTakerDst = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.allowedTakerDst
          );
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.externalCall)
      ExternalCallParams.internalBinaryWrite(
        message.externalCall,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* pmm_common.Address beneficiary_src */ 1:
          message.beneficiarySrc = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.beneficiarySrc
          );
          break;
...
class EventCreatedSrc$Type extends MessageType<EventCreatedSrc> {
  constructor() {
    super("pmm_common.EventCreatedSrc", [
      {
        no: 2,
        name: "give_token_metadata",
        kind: "message",
        T: () => TokenMetadata,
      },
      {
        no: 3,
        name: "take_token_metadata",
        kind: "message",
        T: () => TokenMetadata,
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.Order created_order */ 4:
          message.createdOrder = Order.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* pmm_common.U256 order_id */ 5:
          message.orderId = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.orderId
        ...
        case /* pmm_common.AffiliateFee affiliate_fee */ 7:
          message.affiliateFee = AffiliateFee.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.affiliateFee
        ...
        case /* pmm_common.U256 fix_fee */ 8:
          message.fixFee = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.fixFee
        ...
        case /* pmm_common.U256 percent_fee */ 9:
          message.percentFee = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.percentFee
  ...
  internalBinaryWrite(
    ...
    if (message.giveTokenMetadata)
      TokenMetadata.internalBinaryWrite(
        message.giveTokenMetadata,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.affiliateFee)
      AffiliateFee.internalBinaryWrite(
        message.affiliateFee,
        writer.tag(7, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.Order fulfilled_order */ 4:
          message.fulfilledOrder = Order.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* pmm_common.Address taker_dst */ 6:
          message.takerDst = Address.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.takerDst
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.U256 submission_id */ 3:
          message.submissionId = U256.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
class EventOrderCancelledDst$Type extends MessageType<EventOrderCancelledDst> {
  ...
  create(
    value?: PartialMessage<EventOrderCancelledDst>
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.Order canceled_order */ 4:
          message.canceledOrder = Order.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
class EventSentOrderCancelDst$Type extends MessageType<EventSentOrderCancelDst> {
  ...
  create(
    value?: PartialMessage<EventSentOrderCancelDst>
...
class EventClaimedOrderCancelSrc$Type extends MessageType<EventClaimedOrderCancelSrc> {
  ...
  create(
    value?: PartialMessage<EventClaimedOrderCancelSrc>
...
class PmmEvent$Type extends MessageType<PmmEvent> {
  constructor() {
    super("pmm_common.PmmEvent", [
      ...
      {
        no: 4,
        name: "send_unlock_dst",
        kind: "message",
        oneof: "event",
        T: () => EventSentUnlockDst,
      },
      {
        no: 5,
        name: "order_cancelled_dst",
        kind: "message",
        oneof: "event",
        T: () => EventOrderCancelledDst,
      },
      {
        no: 6,
        name: "send_order_cancel_dst",
        kind: "message",
        oneof: "event",
        T: () => EventSentOrderCancelDst,
      },
      {
        no: 7,
        name: "claimed_unlock_src",
        kind: "message",
        oneof: "event",
        T: () => EventClaimedUnlockSrc,
      },
      {
        no: 8,
        name: "claimed_order_cancel_src",
        kind: "message",
        oneof: "event",
        T: () => EventClaimedOrderCancelSrc,
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* pmm_common.EventCreatedSrc created_src */ 2:
          message.event = {
            oneofKind: "createdSrc",
            createdSrc: EventCreatedSrc.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).createdSrc
            ),
          };
          break;
        ...
        case /* pmm_common.EventClaimedOrderCancelSrc claimed_order_cancel_src */ 8:
          message.event = {
            oneofKind: "claimedOrderCancelSrc",
            claimedOrderCancelSrc:
              EventClaimedOrderCancelSrc.internalBinaryRead(
                reader,
                reader.uint32(),
                options,
  ...
  internalBinaryWrite(
    ...
    if (message.event.oneofKind === "createdSrc")
      EventCreatedSrc.internalBinaryWrite(
        message.event.createdSrc,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
