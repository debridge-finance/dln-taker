...
export const takeAmountUsdEquivalentBetween =
  (minUSDEquivalent: number, maxUSDEquivalent: number): OrderFilterInitializer =>
  async (/* chainId: ChainId */ {}, /* context: OrderFilterInitContext */ {}) =>
  async (order: OrderData, context: FilterContext): Promise<boolean> => {
