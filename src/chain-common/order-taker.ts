...
export class CreatedOrderTaker {
    ...
    constructor(private readonly order: CreatedOrder, logger: Logger) {
    ...
    async fulfill(transactionBuilder: FulfillTransactionBuilder, estimation: OrderEstimation): Promise<TxHash> {
