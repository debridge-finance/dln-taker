...
```sh
git clone --depth 1 --single-branch --branch v1.0.0 git@github.com:debridge-finance/dln-taker.git
```
...
Fetch the source code from Github, picking the given revision (current: `v1.0.0`):
