...
```sh
git clone --depth 1 --single-branch --branch v2.4-latest git@github.com:debridge-finance/dln-taker.git
```
...
Fetch the source code from Github, picking the given revision (current: `v2.4-latest`):
