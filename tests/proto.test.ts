...
function protoTest() {
  ...
  it('can convert u256', () => {
    ...
    const expected = Buffer.from([
      181, 113, 70, 178, 240, 6, 44, 91, 216, 99, 198, 253, 183, 75, 25, 113, 176, 254, 203, 38,
      186, 203, 38, 37, 44, 125, 182, 76, 61, 207, 18, 24,
    ]);
  ...
  xit('can decode json', () => {
    const j = {
      createdSrc: {
        ...
        transactionMetadata: {
          transactionHash: [
            51, 212, 23, 3, 161, 122, 101, 109, 172, 212, 241, 105, 189, 58, 165, 90, 139, 181, 22,
            2, 86, 70, 79, 194, 159, 254, 105, 244, 59, 24, 185, 153, 144, 78, 181, 1, 80, 228, 165,
            207, 208, 216, 96, 178, 139, 60, 52, 254, 158, 106, 196, 105, 84, 192, 10, 138, 191, 88,
            71, 208, 99, 153, 51, 2,
          ],
          blockHash: [
          ...
          initiator: {
            address: [
              214, 162, 161, 41, 59, 101, 45, 80, 13, 56, 8, 19, 136, 105, 13, 34, 68, 58, 60, 120,
              170, 223, 195, 208, 236, 99, 144, 143, 208, 81, 52, 2,
            ],
          },
        },
        giveTokenMetadata: {
        ...
        createdOrder: {
          ...
          take: {
            ...
            tokenAddress: {
              address: [
                160, 184, 105, 145, 198, 33, 139, 54, 193, 209, 157, 74, 46, 158, 176, 206, 54, 6,
                235, 72,
              ],
            },
